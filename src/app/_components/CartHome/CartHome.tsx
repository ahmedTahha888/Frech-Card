    ...
    <>
      <div className="bg-[#F9FAFB] w-full grid md:grid-cols-4  py-8 px-8  gap-5 ">
        ...
        <motion.div
          ...
          className="flex items-center gap-2.5 p-4 bg-white shadow-sm hover:shadow-md transition-shadow duration-300 rounded-xl w-full md:max-ww[228px] xl:max-w-[356px]"
        >
          {/* icon */}
          ...
          {/* content */}
          <div>
            <h3 className="text-[#1E2939] text-sm font-semibold">
              Free Shipping
            </h3>
            <p className="text-[#6A7282] font-light text-xs">
